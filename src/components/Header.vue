<template>
  <div class="header">
    ...
    <div class="right">
      ...
      <img @click="fullScreen" class="fullScreen" src="/img/fullscreen.png" alt="">
      <el-dropdown>
        <span class="el-dropdown-link">
          <img src="/img/user.gif" class="avatar" alt="">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            ...
            <el-dropdown-item @click="GoTo('/login')">退出登录</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </div>
